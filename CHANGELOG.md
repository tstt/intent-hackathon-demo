...
## [v1.2.0] - 2025-12-19
### Added
- 新增“理财（Wealth Management）”意图支持，包含存入、赎回与收益估算等基本动作，UI 中增加相关确认字段与风险提示。
- 提升 ENS 识别准确率：改进解析逻辑与缓存策略，降低错误解析率并对解析失败提供更清晰的错误原因。
- 小幅改进：改进日志与监控点，便于追踪解析与签名验证流程中的异常。

### Notes
- 该版本为 minor 更新（新增功能且向后兼容）。
